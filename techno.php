                ...
                <div class="section-content blog">
                    ...
                    <div class="cards">
                        <?php
                            ...
                            $newsTotalesReq = $db->query("SELECT id FROM news WHERE date >= '$date' AND categorie = 'technology' "); 
                            ...
                            $result = $db->query("SELECT * FROM news WHERE date >= '$date' AND categorie = 'technology' ORDER BY date DESC LIMIT $depart,$newsParPage");
