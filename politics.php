                ...
                <div class="section-content">
                    ...
                    <div class="cards">
                        <?php
                            ...
                            $newsTotalesReq = $db->query('SELECT id FROM news WHERE categorie = "politics" '); 
                            ...
                            $result = $db->query("SELECT * FROM news WHERE categorie = 'politics' ORDER BY date DESC LIMIT $depart,$newsParPage");
                    ...
                    <?php
                        ...
                        if($pageTotales != 1) {
                            ...
                            if($pageCourante > 1) {
                                ...
                                echo '<a href="politics.php?page='.$precedent.'">Précédent</a> ';
                            }

                            if($pageCourante == 3) {
                                echo '<a href="politics.php?page=1">1</a> '; 
                            }
                            ...
                            for($i = $pageCourante - $nbrMaxGD; $i <$pageCourante; $i++) {
                                if($i > 0) {
                                    echo '<a href="politics.php?page='.$i.'">'.$i.'</a> '; 
                                }
                            }
                            ...
                            if($pageCourante < $pageTotales - 2) {
                                echo '<span class="petitPoint">...</span> '; 
                                echo '<a href="politics.php?page='.$pageTotales.'">'.$pageTotales.'</a> '; 
                            }
                            ...
                            if($pageCourante != $pageTotales) {
                                ...
                                echo '<a href="politics.php?page='.$suivant.'">Suivant</a> '; 
                            }
                        }
                    ?>
                </div>
